"""Run the send_pose_goal MoveItPy example against the rox_fr3 (FR3 arm).
...
def generate_launch_description():
    ...
    # (planning pipelines, plan request params, ...) that the example needs.
